...
window.onload = async () => {
  ...
  handleScreenResize();
  renderProducts();
  refreshCartCounter(JSON.parse(sessionStorage.getItem(CART_KEY)).length);
};
...
// JavaScript for Takatof Products Page

// Sort Products Functionality (Placeholder)

/*document.getElementById('create-product').addEventListener('click', (event) => {
    // Perform any additional actions before redirecting, if necessary
